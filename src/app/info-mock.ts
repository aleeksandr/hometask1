...
const places: Place[] = [
  {
    ...
    'phone': 17785089821,
    'weather': {'title': 'Cloudy', 'icon': 'string', 'water': 23, 'temperature': 28},
    ...
    'phone': 20693660559,
    'weather': {'title': 'Sunny', 'icon': 'string', 'water': 27, 'temperature': 38},
    ...
    'phone': 441539724555,
    'weather': {'title': 'Partly cloudy', 'icon': 'string', 'water': 15, 'temperature': 12},
    ...
    'phone': 43766680050,
    'weather': {'title': 'Rainy', 'icon': 'string', 'water': 18, 'temperature': 21},
    ...
    'phone': 39059223912,
    'weather': {'title': 'Windy', 'icon': 'string', 'water': null, 'temperature': 33},
    'social_info': {
    ...
    'address': 'avenue Aristide Briand, 30, Menton, France',
    'phone': 330492418686,
    'weather': {'title': 'Rainy', 'icon': 'string', 'water': 24, 'temperature': 28},
